...
const About = () => {
  ...
  return (
    ...
    {/* about */}
        <motion.div variants={textvariants} className="text-container text-center py-lg-5 pt-lg-2 pb-md-5 p-md-0">
            <h1 className='display-4 fw-bold pt-5 pb-3'>About</h1>
            <p className='px-5'>  
            ...
            <div className="icons gap-3 gap-sm-4 d-flex justify-content-center mt-4 mt-sm-5 mt-md-5 gap-md-3">
                <a href="https://www.linkedin.com/in/abilash-m-8b5b751a3" target='_blank' className='text-white fs-3'><i class="fa-brands fa-linkedin"></i></a>
                <a href="https://github.com/Abilash-7" target='_blank' className='text-white fs-3'><i class="fa-brands fa-github"></i></a>
            </div>
        </motion.div>
        ...
        <motion.div variants={textvariants} className="resume  text-center py-md-5  py-lg-0 py-sm-5">    
            ...
            <div className="buttons d-flex justify-content-center gap-5 p-3">
                <a href="../../../public/assets/Abilash M_Resume.pdf" download className='btn'><i class="fa-solid fa-download pe-3 "></i>Get Resume</a>
                <Link to="/resume" className='btn'><i class="fa-solid fa-eye pe-3"></i>View Resume</Link>
            </div>
        </motion.div>
    </motion.div>
  )
