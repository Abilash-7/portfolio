                     ...
                     <div className="container box d-flex justify-content-center w-100 h-100 align-items-center">
                        <motion.div variants={motionvariants} initial="initial" whileInView="animate" className="row h-100  d-flex justify-content-center m-lg-auto">    
                            ...
                            <motion.div variants={motionvariants} className="text p-md-0  col-lg-6 d-flex flex-column align-items-center  gap-3 ">
                                ...
                                <p className='text-center m-0'>{item.desc}</p>
                                <p style={{color:"#fa4659"}}>Technology Used : <span>{item.tech}</span></p>
                                <div className="buttons d-flex gap-3">
                                    <a href={item.live} target='_blank' className='btn btn-sm px-4 rounded-3'> <i className="fa-solid fa-link pe-1"></i> Live Link</a>
                                    <a href={item.code} className='btn btn-sm rounded-3' target='_blank'><i className="fa-solid fa-code pe-1"></i> Source Code</a>
                                </div>
                            </motion.div>
  ...
  return (
    <div className='container' ref={ref}>
         ...
         <div className="progress-container text-center">
            <h1 className='fw-bold pb-2 display-4'>Projects</h1>
